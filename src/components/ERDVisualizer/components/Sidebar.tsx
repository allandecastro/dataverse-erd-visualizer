    ...
    <div style={{
      ...
      <div style={{ padding: '20px', borderBottom: `1px solid ${borderColor}` }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '16px' }}>
          ...
          <div style={{ flex: 1 }}>
            <div style={{ fontSize: '15px', fontWeight: '600', marginBottom: '2px' }}>Dataverse ERD Visualizer</div>
          ...
          <div style={{ display: 'flex', gap: '6px' }}>
            <a
              ...
              onMouseLeave={(e) => e.currentTarget.style.opacity = '1'}
            >
              <svg width="16" height="16" viewBox="0 0 24 24" fill={isDarkMode ? '#24292f' : '#ffffff'}>
