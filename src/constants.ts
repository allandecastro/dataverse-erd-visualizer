...
/** localStorage key: cached latest-release info + timestamp (throttling) */
export const UPDATE_LAST_CHECK_KEY = 'erd-update-last-check';

/** How long a cached update check stays fresh before re-fetching (24h) */
